 ...
 * 
 */
public class NexusOSSMavenMultiModulePromoterClosure extends AbstractNexusOSSPromoterClosure {
	...
	public NexusOSSMavenMultiModulePromoterClosure(BuildListener listener, String localRepositoryURL,
